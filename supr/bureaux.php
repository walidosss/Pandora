...
while ($line = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
	...
	echo "<td>".$line['ID']."</td>";
	echo "<td>".$line['Nom']."</td>";
	echo "<td>".$line['Longitude']."</td>";
	echo "<td>".$line['Lattitude']."</td>";
	echo "<td>".$line['Altitude']."</td>";
	echo "<td>".$line['Rue']."</td>";
	echo "<td>".$line['Cite']."</td>";
	echo "<td>".$line['Province']."</td>";
	echo "<td>".$line['Reference']."</td>";
	echo "<td>".$line['Note']."</td>";
	echo "<td>".$line['Foto']."</td>";
	echo "<td><a href='modification_b.php?ID=".$line['ID']."'><span class='brocco-icon-pencil' aria-hidden='true'></span></a></td>";
	echo "</tr>";
	$i++;
}
